				...
				<main>
					...
					<div class="details">
						<ul>
							...
							<li class="child">
								<div class="mini-text">
									<img src="assets/pin.svg" class="mini" />
									<p>26197 Huntlosen</p>
								</div>
							</li>
						</ul>
					...
					<br>
						<form class="eintrag" action="meine-einträge.php">
							<div class="form-section">
								...
								<textarea class="desc-text" readonly rows="8">Hier könnte ihre Werbung stehen</textarea>
								<button class="submit" type="submit">Will ich haben!</button>
							</div>
							<div class="image-container">
								<img class="food-img-dsp" src="assets/lecker.jpg" alt="Beispielbild" />
							</div>
						</form>
					</main>
